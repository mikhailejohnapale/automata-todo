...
1. Open in a new tab https://github.com/janmaghuyop/automata-todo
...
```
cd ~/Downloads
git clone git@github.com:username/automata-todo.git
cd automata-todo
```
...
```
git remote add upstream git@github.com:janmaghuyop/automata-todo.git
```
